...
# Как вариант, можно добавить скрипт в планировщик заданий на контроллере домена, установив расписание задачи на начало суток.
...
# В данном случае для поиска используется весь домен в котором запущен скрипт. В большинстве случаев, применительно к средним и мелким конторам, этого достаточно.
